...
//     if (depth === 0) {
//         return { score: stopTime('eval', () => eval(node)), move: null };
//     }
...
// function toc(id) {
//     console.log(monitoring[id].text, `${Date.now() - monitoring[id].time} ms`);
// }